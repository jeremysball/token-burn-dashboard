...
- Each model line's "pricePerMillion" is its provider's published $/M rate per category (source:
  "models.dev" or "openrouter" = live fetched pricing, "local" = static fallback table — prefer
  models.dev, then openrouter, over local as more authoritative when comparing two models that
  both have it). Its "cost" field is what was

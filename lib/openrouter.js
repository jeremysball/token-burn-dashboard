...
function buildOpenRouterPricingRecord(model) {
  ...
  return {
    ...
    input: priceToPerMillion(pricing.prompt ?? pricing.input),
    output: priceToPerMillion(pricing.completion ?? pricing.output),
    cacheRead: priceToPerMillion(pricing.input_cache_read ?? pricing.cache_read ?? pricing.cacheRead),
    cacheWrite: priceToPerMillion(pricing.input_cache_write ?? pricing.cache_write ?? pricing.cacheWrite),
    source: 'openrouter'
  };
}
